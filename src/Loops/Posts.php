...
namespace Carawebs\Carawebs\Loops;

class Posts extends Loop {
  ...
  public function __construct( $override = [], $term = null ) {
    ...
    $this->args = array_merge( $this->args, array_merge( [ 'post_type' => array( 'post' ) ], $override ) );
  ...
  //  *
  //  * Typically used to return a stream of teasers
  //  *
  //  * @param  [type] $term     [description]
  //  * @param  [type] $override [description]
  //  * @return [type]           [description]
  //  */
  // public function projects_loop( $count, $pagination, $term = [], $override = [], $partial = '/partials/project-teaser.php' ) {
  //
  ...
  /**
   * A basic loop for a posts archive page
   *
   * @return [type] [description]
   */
