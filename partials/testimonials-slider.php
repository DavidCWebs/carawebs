    ...
    <div class="col-md-8 col-md-offset-2 text-center lead">
      ...
      <div id="testimonials-carousel" class="testimonials-carousel carousel carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-control-wrap">
          <div class="row">
            <div class="col-xs-4">
              <a class="left" href="#testimonials-carousel" data-slide="prev" title="Previous Testimonial"><i class="fa fa-angle-left"></i></a>
            </div>
            <div class="col-xs-4">
              <a class="play-pause" id="pause-carousel" title="Pause Testimonials"><i class="fa fa-pause"></i></a>
              <a class="play-pause" id="play-carousel" title="Play Testimonials"><i class="fa fa-play"></i></a>
            </div>
            <div class="col-xs-4">
              <a class="right" href="#testimonials-carousel" data-slide="next" title="Next Testimonial"><i class="fa fa-angle-right"></i></a></div>
            </div>
          </div>
        </div>
      </div>
